		...
		<>
			...
			<div className="page-view bg-darken">
				...
				<div className="w-full !mt-4 md:!mt-6 lg:!mt-10 max-w-[1024px] h-full flex flex-col items-center mx-auto px-4">
					<div className="relative z-20 md:text-base -bottom-16 h-[144px] w-[144px] rounded-full overflow-visible border-2 border-primary-light bg-white">
						<Image
					...
					<div className="flex flex-col z-10 relative overflow-hidden items-center justify-start max-w-[25rem] w-full sm:w-[25rem] bg-white rounded border-2 border-primary-light">
						<h1 className="text-4xl md:text-[2.75rem] md:leading-12 pt-14 lg:text-5xl font-extrabold font-inter my-[10px] text-center text-primary-light relative bottom-[0rem]">
							Membership
							<br />
							Portal
						</h1>
