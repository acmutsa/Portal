...
export const EventDescription: FunctionComponent = () => {
	return (
				...
				<div className="col-span-3 pr-[15px] py-[20px]">
					<div className="prose prose-md max-w-none font-raleway font-semibold">
						...
						<ReactMarkdown remarkPlugins={[remarkGfm]}>
							Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi venenatis iaculis nisl
							at congue. Morbi ipsum neque, tincidunt nec sagittis vel, pellentesque a felis. Aenean
							ultrices suscipit libero, ut maximus neque luctus at. Aliquam lobortis, neque quis
							venenatis pretium, dolor est dignissim augue, tristique ornare dolor dui sit amet
							magna. Praesent nec pretium mauris. Orci varius natoque penatibus et magnis dis
							parturient montes, nascetur ridiculus mus. Mauris euismod neque ac vulputate varius.
						</ReactMarkdown>
