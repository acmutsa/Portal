	...
	return (
		<div className="page-view pt-10">
			...
			<EventHeader
				...
				eventHost="ACM"
				eventDescription="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc dignissim urna ut pellentesque molestie. Curabitur non diam dictum, maximus est commodo, tempus nunc. Vestibulum ac aliquam libero, eget sodales urna. Nam pulvinar varius erat. Sed magna nibh, tempor porta nisi et, lobortis facilisis dui. "
			...
			<EventHeader
				title="Game Night"
				imageURL="https://cdn.discordapp.com/attachments/747935348079984671/1030858082986766427/IMG_5507.webp"
				eventHost="ACM"
			...
			<EventHeader
				title="PyNight"
				imageURL="https://cdn.discordapp.com/attachments/749323785324331038/1029096940836761751/BAHPynight.png"
			...
			<EventHeader
				...
				imageURL="https://cdn.discordapp.com/attachments/747935348079984671/1026940390957395968/IMG_4772.jpg"
				eventHost="ACM & IEEE"
