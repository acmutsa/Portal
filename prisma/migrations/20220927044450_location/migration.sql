...
INSERT INTO "new_Events" ("createdAt", "description", "eventEnd", "eventStart", "forcedIsOpen", "formClose", "formOpen", "hasBeenForced", "headerImage", "id", "name", "organization", "pageID") SELECT "createdAt", "description", "eventEnd", "eventStart", "forcedIsOpen", "formClose", "formOpen", "hasBeenForced", "headerImage", "id", "name", "organization", "pageID" FROM "Events";
DROP TABLE "Events";
